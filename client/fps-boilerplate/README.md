...
- Winner blank-block replacement visuals are now registered as mine hover/raycast targets and carry explicit gameplay-cell coordinates, so the revealed winner block remains directly targetable/minable even after default mesh suppression.
