...
export declare function delegateEphemeralAtaIx(payer: PublicKey, ephemeralAta: PublicKey, bump: number, validator?: PublicKey): TransactionInstruction;
export declare function initShuttleEphemeralAtaIx(payer: PublicKey, shuttleEphemeralAta: PublicKey, shuttleAta: PublicKey, shuttleWalletAta: PublicKey, owner: PublicKey, mint: PublicKey, shuttleId: number, bump: number): TransactionInstruction;
export declare function delegateShuttleEphemeralAtaIx(payer: PublicKey, shuttleEphemeralAta: PublicKey, shuttleAta: PublicKey, bump: number, validator?: PublicKey): TransactionInstruction;
export declare function setupAndDelegateShuttleEphemeralAtaWithMergeIx(payer: PublicKey, shuttleEphemeralAta: PublicKey, shuttleAta: PublicKey, owner: PublicKey, sourceAta: PublicKey, destinationAta: PublicKey, shuttleWalletAta: PublicKey, mint: PublicKey, shuttleId: number, bump: number, amount: bigint, validator?: PublicKey): TransactionInstruction;
export declare function depositAndDelegateShuttleEphemeralAtaWithMergeAndPrivateTransferIx(payer: PublicKey, shuttleEphemeralAta: PublicKey, shuttleAta: PublicKey, owner: PublicKey, sourceAta: PublicKey, destinationAta: PublicKey, shuttleWalletAta: PublicKey, mint: PublicKey, shuttleId: number, bump: number, amount: bigint, minDelayMs: bigint, maxDelayMs: bigint, split: number, validator?: PublicKey): TransactionInstruction;
export declare function withdrawThroughDelegatedShuttleWithMergeIx(payer: PublicKey, shuttleEphemeralAta: PublicKey, shuttleAta: PublicKey, owner: PublicKey, ownerAta: PublicKey, shuttleWalletAta: PublicKey, mint: PublicKey, shuttleId: number, bump: number, amount: bigint, validator?: PublicKey): TransactionInstruction;
...
export declare function undelegateAndCloseShuttleEphemeralAtaIx(payer: PublicKey, shuttleEphemeralAta: PublicKey, shuttleAta: PublicKey, shuttleWalletAta: PublicKey, escrowIndex?: number): TransactionInstruction;
...
export declare function createEataPermissionIx(ephemeralAta: PublicKey, payer: PublicKey, bump: number, flags?: number): TransactionInstruction;
export declare function resetEataPermissionIx(ephemeralAta: PublicKey, payer: PublicKey, bump: number, flags?: number): TransactionInstruction;
export declare function delegateEataPermissionIx(payer: PublicKey, ephemeralAta: PublicKey, bump: number, validator: PublicKey): TransactionInstruction;
